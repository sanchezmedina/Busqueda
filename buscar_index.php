    ...
    <body>
      <!--[if lt IE 7]><p class=chromeframe>Your browser is <em>ancient!</em> <a href="http://browsehappy.com/">Upgrade to a different browser</a> or <a href="http://www.google.com/chromeframe/?redirect=true">install Google Chrome Frame</a> to experience this site.</p><![endif]-->
        <section id="contenedor">
            ...
            <section id="botonera">
                <h2>Notarios de Juliaca</h2>
                <ul>
                    <li class="botones">
                        <a href="buscar_otor.php">Nombre del Otorgante</a>
                    </li>
                    <li class="botones">
                        <a href="buscar_favor.php">Nombre del Favorecido</a>
                    </li>
                    <li class="botones">
                        <a href="buscar_otor_juri.php">Nombre del Otorgante Juridico</a>
                    </li>
                    <li class="botones">
                        <a href="buscar_favor_juri.php">Nombre del Favorecido Juridico</a>
                    </li>
                    <li class="botones">
                        <a href="buscar_x_fecha.php">Buscar por Fecha</a>
                    </li>
                </ul>
            </section>
